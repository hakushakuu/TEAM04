                    ...
                    <form method="POST">
                        <div class="form-control">
                            ...
                            <input type="text" id="title" name="project_title"
                                placeholder="Enter Project Title" value="<?php echo $project['project_title'];?>" required>
                        </div>
                        ...
                        <div class="form-control">
                            ...
                            <textarea placeholder="Enter description here.." required name="project_details" ><?php echo $project['project_details'];?></textarea>
                        </div>
                        
                        <button type="button" class="button"><a href="<?php echo base_url()."project/view/".$project['project_id']."/".$project['project_publisher_id']?>">Cancel</a></button>
