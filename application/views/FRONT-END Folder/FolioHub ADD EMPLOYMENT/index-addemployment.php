...
<head>
	...
	<title>FolioHub | ADD EMPLOYMENT</title>
	<link rel="icon" href="<?=base_url()?>assets/css-img/addupdateemployment/foliohub-logo.png">

	<link rel="stylesheet" href="<?=base_url()?>assets/css-img/addupdateemployment/style-addemployment.css">
		...
		<div class="addemployment-content">
			<form method="post" id="try">
				...
				<div class="wrap-two">
					...
					<input type="text" name="employment_company" required>
					<span class="event-one"></span>
				</div>
				<div class="wrap-two">
					<label>Title/Position</label>
					<input type="text" name="employment_position" required>
					<span class="event-one"></span>
				</div>
				...
				<div class="wrap-two">
					...
					<input type="month" name="employment_start" required>
					<span class="event-one"></span>
				</div>
				...
				<div class="wrap-one">
					<div class="cont-one">
						...
						<input type="month" id="monthInput" name="employment_end" required>
					</div>
					<div class="cont-two">
						<label>Up to Present</label>
						<div class="for-present">&nbsp;
							<input type="checkbox" id="checkbox" class="checkbox-size" name="employment_end" value="Present"/><span class="event-one"></span>&nbsp;&nbsp;&nbsp;&nbsp;<span>Present</span> 
						</div>
					</div>
				</div> 
