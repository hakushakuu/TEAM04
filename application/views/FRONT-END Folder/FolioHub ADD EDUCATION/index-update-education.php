		...
		<div class="addemployment-content">
			<form method="POST" id="try">
				...
				<div class="wrap-two">
					...
					<input type="text" name="college_name" value="<?php echo $college['college_name'] ?>" required>
				...
				<div class="wrap-two">
					<label>Course</label>
					<input type="text" name="college_course" value="<?php echo $college['college_course'] ?>" required>
					<span class="event-one"></span>
				</div>

				<div class="wrap-two">
					<label>Date Start</label>
					<input type="month" name="college_date_start" value="<?php echo $college['college_date_start'] ?>" required>
					<span class="event-one"></span>
				</div>
				...
				<div class="wrap-one">
					<div class="cont-one">
						...
						<input type="month" name="college_date_end" id="monthInput" value="<?=($college['college_date_end'] != "Present")? $college['college_date_end']:""?>" <?=($college['college_date_end'] == "Present")? "disabled":""?> required>
					</div>
					<div class="cont-two">
						<label>Up to Present</label>
						<div class="for-present">&nbsp;
							<input type="checkbox" id="checkbox" class="checkbox-size" name="college_date_end" value="Present" <?=($college['college_date_end'] == "Present")? "checked":"" ?> required/><span class="event-one"></span>&nbsp;&nbsp;&nbsp;&nbsp;<span>Present</span> 
						</div>
					</div>
				</div> 
