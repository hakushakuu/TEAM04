...
<body>
    ...
    ?>
        <div>
            ...
            <button type='button'><a href='<?php echo base_url()."messages/addMessage"?>'>Message</a></button>
            <button type='button'><a href='<?php echo base_url()."messages/viewMessage"?>'>View Message</a></button>
        </div>
